          ...
          {loading ? (
            ...
            <table className="min-w-full text-sm border-collapse border border-slate-200">
              <thead className="bg-slate-100 text-slate-700 text-xs font-semibold uppercase">
                <tr>
                  <th className="border border-slate-200 px-4 py-2 text-center w-14">No</th>
                  <th className="border border-slate-200 px-4 py-2 text-left">Nama LKS</th>
                  <th className="border border-slate-200 px-4 py-2 text-left">Petugas</th>
                  <th className="border border-slate-200 px-4 py-2 text-center">Status</th>
                  <th className="border border-slate-200 px-4 py-2 text-center">Tanggal</th>
                  <th className="border border-slate-200 px-4 py-2 text-center w-32">Aksi</th>
                </tr>
              </thead>
              <tbody>
                {filtered.length === 0 ? (
                  ...
                  filtered.map((item, i) => (
                    ...
                    >
                      ...
                      <td className="border border-slate-200 px-4 py-2">{item.lks?.nama || "-"}</td>
                      <td className="border border-slate-200 px-4 py-2">{item.petugas?.name || "-"}</td>
