...
const LKSKlienForm = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-2xl border p-8 mt-4">
      <h1 className="text-2xl font-bold text-emerald-700 mb-2">Tambah Data Klien</h1>
      <p className="text-gray-500 mb-6">Lengkapi form berikut untuk menambahkan data klien baru.</p>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="number" name="nik" value={form.nik} onChange={handleChange} required
            className="w-full border rounded-lg px-3 py-2" placeholder="16 digit" />
        </div>
        ...
        <div>
          ...
          <input type="text" name="kelurahan" value={form.kelurahan}
            onChange={handleChange} className="w-full border rounded-lg px-3 py-2" required />
        </div>
        ...
        <div>
          ...
          <textarea name="alamat" value={form.alamat} onChange={handleChange}
            className="w-full border rounded-lg px-3 py-2" rows={3} required />
        </div>

        {/* Kecamatan otomatis */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">Kecamatan (otomatis)</label>
          <input type="text"
        ...
        {/* Jenis Bantuan */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">Jenis Bantuan</label>
          <select name="jenis_bantuan" value={form.jenis_bantuan} onChange={handleChange}
            className="w-full border rounded-lg px-3 py-2">
            <option value="">Pilih</option>
        ...
        {/* Kelompok Umur */}
        <div>
          <label className="block font-semibold text-gray-700 mb-1">Kelompok Umur</label>
          <select name="kelompok_umur" value={form.kelompok_umur} onChange={handleChange}
            className="w-full border rounded-lg px-3 py-2">
            <option value="">Pilih</option>
        ...
        <div>
          ...
          <select name="status_pembinaan" value={form.status_pembinaan} onChange={handleChange}
            className="w-full border rounded-lg px-3 py-2">
            <option value="">Pilih</option>
      ...
      <div className="flex justify-between mt-10">
        <button onClick={() => navigate("/lks/klien")}
          className="flex items-center gap-2 px-5 py-2 bg-gray-100 rounded-lg"> <ArrowLeft size={16} /> Kembali</button>
